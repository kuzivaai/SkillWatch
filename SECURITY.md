...
For issues involving the SSRF protection, DNS pinning, or escape sequence stripping specifically, please email [maintainer contact: open a private GitHub security advisory] first so the fix can be prepared before disclosure.
