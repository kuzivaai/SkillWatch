...
def main() -> int:
    ...
    if args.remanifest:
        ...
        copies = [str(source)]
        for sibling in ("/mnt/d/skillwatch-archive", "/mnt/c/Users/USER/skillwatch-archive"):
    ...
    dirs = args.archive_dir or [
        f"/home/USER/.skillwatch-archive/realpage-{today}",
        f"/mnt/d/skillwatch-archive/realpage-{today}",
        f"/mnt/c/Users/USER/skillwatch-archive/realpage-{today}",
    ]
