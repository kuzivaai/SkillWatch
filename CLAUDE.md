...
- **Positioning is OWASP AST05.** SkillWatch maps to AST05 "Untrusted External Instructions" in the OWASP Agentic Skills Top 10 (v1.0, 2026 Edition). That project is an OWASP **Incubator** initiative, not a flagship standard — the qualifier is mandatory in every public claim. AST07 "Update Drift" is adjacent (version pinning) and may be cited only as a partial fit.
